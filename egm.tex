...
\end{align}
To be continued...
%Note that $u''(\cdot)<0$ by assumption. First, I derive a necessary and sufficient condition for inequality (\ref{ineq:toshow}) to hold for a given, realized productivity level $z'$. Dividing by $-u''(c^{n,*}_1)$ yields
%\begin{align}
