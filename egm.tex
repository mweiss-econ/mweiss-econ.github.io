...
+&  E_z[u'(c^{a,*}_1)](\lambda + (1-\lambda)(q+div)) - (1-\lambda)div E_z[u'(c^{n,*}_1)] -\nonumber \\- &  Rq ( (R^d/R-\lambda) E_z[u'(c^{a,*}_1)] - (1-\lambda) E_z[u'(c^{n,*}_1)])\\
= & E_z[u'(c^{a,*}_1)]\left(\lambda (R^d-1-R+1+Rq)+(1-\lambda)(q+div)-R^dq\right) + \nonumber \\
+& E_z[u'(c^{n,*}_1)](1-\lambda)(R^d-1-R-div+Rq)\\
= & E_z[u'(c^{a,*}_1)] \left( \lambda(LP - qLP) + (1-\lambda)(q+div-qR^d) \right)+\nonumber \\+ &E_z[u'(c^{n,*}_1)](1-\lambda)\left(LP - 1 - q(LP - 1)\right)\\
=& (1-q)\left(\lambda LP E_z[u'(c^{a,*}_1)] - (1-\lambda)(1-LP)E_z[u'(c^{n,*}_1)]\right)\\
\end{align}

$\rho = 0$ for $q=1$?? THAT CANNOT BE...
...
\begin{align}
R(1-q)\left(\lambda LP E_z[u''(c^{a,*}_1)] - (1-\lambda)(1-LP)E_z[u''(c^{n,*}_1)]\right) > 0
\label{ineq:toshow}
\end{align}
